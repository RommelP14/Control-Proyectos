...
document.addEventListener("DOMContentLoaded", () => {
    document.querySelector("#formulario_proyecto_alumno").addEventListener('submit', function (event) {
...
function manejarRespuestaComparacion(response) {
    ...
    if (estatus === "Para aprobación") {
        MensajeRedirect(
            ...
            '/ControlProyecto/app/ver/Ver_Proyectos_View_Alumnos_SRV.do?accion=listarProyectosAlumnos'
        );
