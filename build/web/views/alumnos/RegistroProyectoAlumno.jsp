...
<html>
    ...
    <body>
        ...
        <div class="container">
            <%@include file="/views/templates/navbarAlumno.jsp" %>
            <div id="cont">
                <div id="registroproyectoP" name="panel" class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form id="formulario_proyecto_alumno" name="formulario_proyecto">
                            <div class="col-md-12">
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/jsgenerados/registro_proyecto_alumno.js" type="text/javascript"></script>
